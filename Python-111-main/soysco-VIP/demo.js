    ...
    var d = {}
        ...
        mM8E: function (a) {
            var c = this.i3x
                ...
                , k = this.blockSize
                , b = j / (4 * k)
                , b = a ? u.ceil(b) : u.max((b | 0) - this.TO1x, 0);
            a = b * k;
            j = u.min(4 * a, j);
            if (a) {
                for (var q = 0; q < a; q += k)
...
CryptoJS.lib.Cipher || function (u) {
    var p = CryptoJS
        ...
        createEncryptor: function (e, a) {
            return this.create(this.IJ5O, e, a)
        },
        createDecryptor: function (e, a) {
            return this.create(this.buQ9H, e, a)
        },
        init: function (e, a, b) {
    ...
    d.BlockCipher = v.extend({
        ...
        reset: function () {
            ...
            var a = this.cfg
                , b = a.iv
                , a = a.mode;
            if (this.TD1x == this.IJ5O)
                var c = a.createEncryptor;
            else
                c = a.createDecryptor,
                    this.TO1x = 1;
            this.eQ5V = c.call(a, this, b && b.words)
        },
        sK0x: function (a, b) {
            this.eQ5V.processBlock(a, b)
        },
        og8Y: function () {
...
(function () {
        ...
        var H = [0, 1, 2, 4, 8, 16, 32, 64, 128, 27, 54]
            , d = d.AES = p.extend({
            mb7U: function () {
                for (var a = this.J3x, c = a.words, d = a.sigBytes / 4, a = 4 * ((this.bhT4X = d + 6) + 1), e = this.buR9I = [], j = 0; j < a; j++)
                    if (j < d)
                        e[j] = c[j];
                    else {
                        var k = e[j - 1];
            ...
            encryptBlock: function (a, b) {
                this.Du3x(a, b, this.buR9I, t, r, w, v, l)
            },
            decryptBlock: function (a, c) {
                var d = a[c + 1];
                a[c + 1] = a[c + 3];
                a[c + 3] = d;
                this.Du3x(a, c, this.buU9L, b, x, q, n, s);
                d = a[c + 1];
                a[c + 1] = a[c + 3];
                a[c + 3] = d
            },
            Du3x: function (a, b, c, d, e, j, l, f) {
                for (var m = this.bhT4X, g = a[b] ^ c[0], h = a[b + 1] ^ c[1], k = a[b + 2] ^ c[2], n = a[b + 3] ^ c[3], p = 4, r = 1; r < m; r++)
...
//js代码。多次调试可以发现e，f，g是固定不变的，d 随着id的改变而改变

page = '{"rid":"R_SO_4_27901965","threadId":"R_SO_4_27901965","pageNo":"1","pageSize":"20","cursor":"-1","offset":"1","orderType":"1","csrf_token":""}'
num1 = '010001'
...
function data(page, num1, str2, str1) {
    var h = {}
        // , i = a(16);//函数a获得的一串16位随机字符串，尝试用固定的'sbHs7OAqA6CWW0vP'代替
        , i = "sbHs7OAqA6CWW0vP";//函数a获得的一串16位随机字符串，尝试用固定的'sbHs7OAqA6CWW0vP'代替
    h.encText = b(page, str1),//前面参数名字修改了，这边也接着修改
        h.encText = b(h.encText, i),  // h.encText再次加密此次加密的参数为前一次加密的结果，和随便变量i
        h.encSecKey = c(i, num1, str2) //前面参数名字修改了，这边也接着修改，通过函数c获取encSecKey
    return h //最终返回的h就是我们需要的表单参数
}

console.log(data(page, num1, str2, str1))
