...
def create_main_window(settings):
    ...
    layout = [[sg.Menu(menu_def)],
              [sg.Text('Bitcoin bruteforcer - Bitbruter', size=(50, 1), font=('Comic sans ms', 13)),
               sg.Button('', key='paypal', size=(12, 1),
              ...
              [sg.Text('Select number of bytes', size=(30, 1), font=('Comic sans ms', 10)),
               sg.Spin(values=('8', '16', '32', '64', '128', '256', '512', '1024', '2048', '4096'), size=(6, 1),
                       key='num')],
