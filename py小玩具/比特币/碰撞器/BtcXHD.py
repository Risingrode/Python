...
def mmdrza_t():
    ...
    while True:
        ...
        if addr1 in add:
            ...
            print(Fore.RED, '[+] TOTAL:', Fore.WHITE, str(z), Fore.YELLOW, '- Win:', Fore.CYAN, str(w), Fore.WHITE,
                  Back.RED, str(priv), Style.RESET_ALL, end='\r')
            z += 1
