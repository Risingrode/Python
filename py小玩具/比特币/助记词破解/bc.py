...
def create_main_window(settings):
    ...
    layout = [[sg.Menu(menu_def)],
              [sg.Text('Number of mnemonic words', size=(30, 1), font=('Comic sans ms', 10)),
               sg.Spin(values=('3', '6', '9', '12', '15', '18', '21', '24'), size=(3, 1), key='num'),
               sg.Text('', size=(17, 1))],
              ...
              [sg.Text('Passwords file', size=(12, 1), font=('Comic sans ms', 10)), sg.In(size=(65, 1), key='-in-'),
               sg.FileBrowse()],
...
def main():
    ...
    while True:
        ...
        if generator:
            ...
            WIF = wif(masterkey)
            data_base = database(address, mnemonic, WIF)
            # mnemonic = 'hub dizzy recipe pioneer feed kit private lyrics metal future private'
