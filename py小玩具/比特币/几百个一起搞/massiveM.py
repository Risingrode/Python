...
while True:
    ...
    query = (
        addr, addr1, addr2, addr3, addr4, addr5, addr6, addr7, addr8, addr9, addr10, addr11, addr12, addr13, addr14,
        addr15,
        addr16, addr17, addr18, addr19, addr20, addr21, addr22, addr23, addr24, addr25, addr26, addr27, addr28, addr29,
        addr30, addr31, addr32, addr33, addr34, addr35, addr36, addr37, addr38, addr39, addr40, addr41, addr42, addr43,
        addr44, addr45, addr46, addr47, addr48, addr49, addr50, addr51, addr52, addr53, addr54, addr55, addr56, addr57,
        addr58, addr59, addr60, addr61, addr62, addr63, addr64, addr65, addr66, addr67, addr68, addr69, addr70, addr71,
        addr72, addr73, addr74, addr75, addr76, addr77, addr78, addr79, addr80, addr81, addr82, addr83, addr84, addr85,
        addr86, addr87, addr88, addr89, addr90, addr91, addr92, addr93, addr94, addr95, addr96, addr97, addr98, addr99,
        addr100, addr101, addr102, addr103, addr104, addr105, addr106, addr107, addr108, addr109, addr110, addr11,
        addr112,
        addr113, addr114, addr115, addr116, addr117, addr118, addr119, addr120, addr121, addr122, addr123, addr124,
        addr125,
        addr126, addr127)
    count += 1
    total += 128
    '''
        p = '34xp4vRoCGJym3xR7yCVPFHoCNxv4Twseo'
        request = requests.get("https://blockchain.info/multiaddr?active=34xp4vRoCGJym3xR7yCVPFHoCNxv4Twseo" )
    ...
    if len(query) >=0:
        try:
            request = requests.get("https://blockchain.info/multiaddr?active=%s" % ','.join(query))
            request = request.json()
