...
class mainbot:
    ...
    def get_user(self):
        ...
        try:
            ...
            address = par.find("input", {"type": "text", "id": "btcaddress", "class": "form-control", "name": "address",
                                         "aria-describedby": "helpBlock"}).get("value")
    ...
    def countdown(self, second):
        while second:
            ...
            timer = self.col(97) + " [" + self.col(92) + "•" + self.col(97) + "] Waiting ⟨{:02d}:{:02d}⟩ ".format(mins,
                                                                                                                  secs)
            print(timer, end="\r")
            time.sleep(1)
            second -= 1
    ...
    def get_claim(self):
        if not os.path.exists(".cookie"):
            print(self.col(97) + "\n [" + self.col(92) + "•" + self.col(
                97) + "] Please take cookies from the web cryptowin.io")
            open(".cookie", "w").write(
                input(self.col(97) + " [" + self.col(92) + "•" + self.col(97) + "] Input cookie : "))
        self.ses.headers.update({"Host": "cryptowin.io", "cache-control": "max-age=0", "upgrade-insecure-requests": "1",
        ...
        print("")
        print(self.col(97) + " [" + self.col(92) + "+" + self.col(97) + "] Getting Account Info...");
        time.sleep(2.4);
        print(self.col(97) + " [" + self.col(92) + "+" + self.col(97) + "] creator  : kingtebe\n" + self.col(
            97) + " [" + self.col(92) + "+" + self.col(97) + "] support  : https://t.me/Captain_bulls\n" + self.col(
            97) + " [" + self.col(92) + "+" + self.col(97) + "] username :",
              str(account[0]) + "\n" + self.col(97) + " [" + self.col(92) + "+" + self.col(97) + "] balance  :",
              str(account[1]), "BTC\n" + self.col(97) + " [" + self.col(92) + "+" + self.col(97) + "] referral :",
              str(account[2]) + "\n" + self.col(97) + " [" + self.col(92) + "+" + self.col(97) + "] address  :",
        ...
        while True:
            try:
                ...
                try:
                    ...
                    print(self.col(97) + " [" + self.col(92) + self.time + self.col(97) + "]" + earn.group(1).replace(
                        "<b>", "").replace("</b>", "").removeprefix("'success',").replace("'", "").replace(
                        "You have successfully claimed", "successfully claimed").replace("!", "") + self.col(
                        90) + " - " + self.col(97) + repr[1])
                    self.countdown(int(60 * 15))
                except AttributeError:
                    print(self.col(97) + " [" + self.col(92) + "!" + self.col(97) + "] Captcha invalid ", flush=True,
                          end="\r")
                    continue
