    ...
    for i in range(0, len(mylist)):
        ...
        if len(passphrase) < 64:
            ...
            if int(bal) > 0:
                ...
                f1.close()
                print(Fore.GREEN, 'Address:', Fore.YELLOW, str(address), Fore.YELLOW, '          TXID:', Fore.WHITE,
                      str(bal), Fore.GREEN, ' Balance:', Fore.CYAN, str(val), Fore.GREEN,
                      ' ----- PrivateKey And Other Details Saved -----', Style.RESET_ALL, Fore.BLUE,
                      '\n    ----------------------------------------------------------------------', Style.RESET_ALL)
                w += 1
                if str(val) != str(ifbtc):
                    s += 1
                    print(Fore.YELLOW, 'Address:', Back.GREEN, Fore.BLUE, str(address), Style.RESET_ALL, Fore.GREEN,
                          '          TXID:', Fore.MAGENTA, str(bal), Fore.GREEN,
                          ' Balance:', Fore.MAGENTA, str(val), Fore.YELLOW, '\nPrivateKey: ', Back.GREEN, Fore.CYAN,
                          str(private_key), Style.RESET_ALL, Fore.MAGENTA, '  -- ', str(passphrase), Fore.BLUE,
