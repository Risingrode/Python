    ...
    while True:
        ...
        if MIZ.prevhash != MIZ.updatedPrevHash:
            ...
            logg('[*] Best difficulty will trying to solve block {} was {}'.format(work_on + 1,
                                                                                   MIZ.nHeightDiff[work_on + 1]))
            print('[', timer(), '] [*] Best difficulty will trying to solve block  {} was {}'.format(work_on + 1,
                                                                                                     MIZ.nHeightDiff[
                                                                                                         work_on + 1]))
...
class MainWindow():
    def __init__(self):
        ...
        self.plus = tkinter.Button(self.windowcal, text="+", width=4, font=("arial", 15, "bold"), fg="purple",
                                   bg="#F0F0F0", activebackground="#F0F0F0", command=lambda: self.opr("+"),
                                   relief=RAISED, bd=3).place(x=530, y=110)
        self.subs = tkinter.Button(self.windowcal, text="-", width=4, font=("arial", 15, "bold"), fg="purple",
                                   bg="#F0F0F0", activebackground="#F0F0F0", command=lambda: self.opr("-"),
                                   relief=RAISED, bd=3).place(x=530, y=170)
        self.mul = tkinter.Button(self.windowcal, text="X", width=4, font=("arial", 15, "bold"), fg="purple",
                                  bg="#F0F0F0", activebackground="#F0F0F0", command=lambda: self.opr("X"),
                                  relief=RAISED, bd=3).place(x=605, y=110)
        self.div = tkinter.Button(self.windowcal, text="/", width=4, font=("arial", 15, "bold"), fg="purple",
                                  bg="#F0F0F0", activebackground="#F0F0F0", command=lambda: self.opr("/"),
                                  relief=RAISED, bd=3).place(x=605, y=170)
        self.rad = tkinter.Button(self.windowcal, text="Radian", width=11, font=("arial", 15, "bold"), fg="purple",
                                  bg="#F0F0F0", activebackground="#F0F0F0", command=lambda: self.opr("Radian"),
                                  relief=RAISED, bd=3).place(x=690, y=260)
        self.reci = tkinter.Button(self.windowcal, text="1/x", width=4, font=("arial", 15, "bold"), fg="purple",
                                   bg="#F0F0F0", activebackground="#F0F0F0", command=lambda: self.opr("Reciprocal"),
                                   relief=RAISED, bd=3).place(x=230, y=260)
        self.sqr = tkinter.Button(self.windowcal, text="X^2", width=4, font=("arial", 15, "bold"), fg="purple",
                                  bg="#F0F0F0", activebackground="#F0F0F0", command=lambda: self.opr("Square"),
                                  relief=RAISED, bd=3).place(x=367, y=260)
        self.cube = tkinter.Button(self.windowcal, text="X^3", width=4, font=("arial", 15, "bold"), fg="purple",
                                   bg="#F0F0F0", activebackground="#F0F0F0", command=lambda: self.opr("Cube"),
                                   relief=RAISED, bd=3).place(x=367, y=310)
        self.equal = tkinter.Button(self.windowcal, text="=", width=11, font=("arial", 18, "bold"), fg="green",
                                    bg="#F0F0F0", activebackground="#F0F0F0", command=self.evaluation_opr,
                                    relief=RAISED, bd=3, ).place(x=690, y=130)
        self.braincal = tkinter.Button(self.windowcal, text="Sum to Brain Wallet", width=16, font=("arial", 12, "bold"),
                                       fg="green", bg="#F0F0F0", activebackground="#F0F0F0",
                                       command=self.Random_brain_cal, relief=RAISED, bd=3, ).place(x=690, y=195)
        self.get_infoCAL = tkinter.Button(self.windowcal, text="Information/Help", width=16, font=("arial", 10, "bold"),
                                          activebackground="#F0F0F0", fg="red", bg="#F0F0F0",
                                          command=self.informationcal, relief=RAISED, bd=3).place(x=710, y=535)
        self.sqrt = tkinter.Button(self.windowcal, text="Square root", width=11, font=("arial", 15, "bold"),
                                   fg="purple", bg="#F0F0F0", activebackground="#F0F0F0",
                                   command=lambda: self.opr("Square root"), relief=RAISED, bd=3).place(x=432, y=260)
        self.cubert = tkinter.Button(self.windowcal, text="Cube root", width=11, font=("arial", 15, "bold"),
                                     fg="purple", bg="#F0F0F0", activebackground="#F0F0F0",
                                     command=lambda: self.opr("Cube root"), relief=RAISED, bd=3).place(x=432, y=310)
        self.log2 = tkinter.Button(self.windowcal, text="log2", width=8, font=("arial", 15, "bold"), fg="purple",
                                   bg="#F0F0F0", activebackground="#F0F0F0", command=lambda: self.opr("log2"),
                                   relief=RAISED, bd=3).place(x=580, y=260)
        self.log10 = tkinter.Button(self.windowcal, text="log10", width=8, font=("arial", 15, "bold"), fg="purple",
                                    bg="#F0F0F0", activebackground="#F0F0F0", command=lambda: self.opr("log10"),
                                    relief=RAISED, bd=3).place(x=580, y=310)
        self.exponent = tkinter.Button(self.windowcal, text="e^x", width=4, font=("arial", 15, "bold"), fg="purple",
                                       bg="#F0F0F0", activebackground="#F0F0F0", command=lambda: self.opr("Exponent"),
                                       relief=RAISED, bd=3).place(x=300, y=260)
        self.power = tkinter.Button(self.windowcal, text="X^Y", width=4, font=("arial", 15, "bold"), fg="purple",
                                    bg="#F0F0F0", activebackground="#F0F0F0", command=lambda: self.opr("x^y"),
                                    relief=RAISED, bd=3).place(x=300, y=310)
        self.factorial = tkinter.Button(self.windowcal, text="n!", width=4, font=("arial", 15, "bold"), fg="purple",
                                        bg="#F0F0F0", activebackground="#F0F0F0", command=lambda: self.opr("Factorial"),
                                        relief=RAISED, bd=3).place(x=15, y=310)
        self.mod = tkinter.Button(self.windowcal, text="Modulus", width=11, font=("arial", 15, "bold"), fg="purple",
                                  bg="#F0F0F0", activebackground="#F0F0F0", command=lambda: self.opr("Modulus"),
                                  relief=RAISED, bd=3).place(x=690, y=310)
        self.reset = tkinter.Button(self.windowcal, text="Reset", width=5, font=("arial", 13, "bold"), fg="purple",
                                    bg="#F0F0F0", activebackground="#F0F0F0", command=self.reset_now, relief=RAISED,
                                    bd=3).place(x=575, y=218)
        self.sin = tkinter.Button(self.windowcal, text="sin", width=4, font=("arial", 15, "bold"), fg="purple",
                                  bg="#F0F0F0", activebackground="#F0F0F0", command=lambda: self.opr("sin"),
                                  relief=RAISED, bd=3).place(x=90, y=310)
        self.cos = tkinter.Button(self.windowcal, text="cos", width=4, font=("arial", 15, "bold"), fg="purple",
                                  bg="#F0F0F0", activebackground="#F0F0F0", command=lambda: self.opr("cos"),
                                  relief=RAISED, bd=3).place(x=15, y=260)
        self.tan = tkinter.Button(self.windowcal, text="tan", width=4, font=("arial", 15, "bold"), fg="purple",
                                  bg="#F0F0F0", activebackground="#F0F0F0", command=lambda: self.opr("tan"),
                                  relief=RAISED, bd=3).place(x=90, y=260)
        self.cot = tkinter.Button(self.windowcal, text="cot", width=4, font=("arial", 15, "bold"), fg="purple",
                                  bg="#F0F0F0", activebackground="#F0F0F0", command=lambda: self.opr("cot"),
                                  relief=RAISED, bd=3).place(x=160, y=260)
        self.lcm = tkinter.Button(self.windowcal, text="LCM", width=4, font=("arial", 15, "bold"), bg="#F0F0F0",
                                  fg="purple", activebackground="#F0F0F0", command=lambda: self.opr("lcm"),
                                  relief=RAISED, bd=3).place(x=160, y=310)
        self.hcf = tkinter.Button(self.windowcal, text="HCF", width=4, font=("arial", 15, "bold"), bg="#F0F0F0",
                                  fg="purple", activebackground="#F0F0F0", command=lambda: self.opr("hcf"),
                                  relief=RAISED, bd=3).place(x=230, y=310)
        self.result_name = tkinter.Label(self.windowcal, text="Result: ", width=8, font=("arial", 16, "bold", "italic"),
                                         fg="black", bg="#F0F0F0").place(x=340, y=360)
        self.result = tkinter.Entry(self.windowcal, font=("Helvetica", 20, "bold", "italic"),
                                    textvar=self.text_valuecal, bd=5, width=56, relief=SUNKEN,
                                    disabledbackground="white", foreground="purple")
        self.result.place(x=10, y=390)
        tkinter.Label(self.windowcal, text="Number 1 ", width=8, font=("arial", 15, "bold", "italic"), bg="#F0F0F0",
                      fg="black").place(x=10, y=115)
        self.number1 = tkinter.Entry(self.windowcal, width=31, bg="#3d3d3d", font=("arial", 16, "bold", "italic"),
                                     insertbackground="gold", fg="gold", bd=3, relief=SUNKEN)
        self.number1.place(x=130, y=115)
        self.number1.focus()
        tkinter.Label(self.windowcal, text="Number 2 ", width=8, font=("arial", 16, "bold", "italic"), fg="black",
                      bg="#F0F0F0").place(x=10, y=195)
        self.number2 = tkinter.Entry(self.windowcal, width=31, bg="#3d3d3d", font=("arial", 16, "bold", "italic"),
                                     insertbackground="gold", fg="gold", relief=SUNKEN, bd=4)
        self.number2.place(x=130, y=195)
        self.operator_name = tkinter.Label(self.windowcal, text="Operation ", width=12,
                                           font=("arial", 16, "bold", "italic"), bg="#F0F0F0", fg="#d96b6b").place(x=10,
                                                                                                                   y=155)
        self.operator = tkinter.Entry(self.windowcal, width=12, font=("arial", 16, "bold", "italic"),
                                      disabledbackground="#3d3d3d", disabledforeground="gold", state="disable",
                                      textvar=self.textoperator, bd=5, relief=SUNKEN)
        ...
        self._btc_bin = tkinter.Button(self.main_frame, text="Bin", font=("Consolas", 16),
                                       command=self.evt_btc_bin).place(x=300, y=150)
        self._btc_dec = tkinter.Button(self.main_frame, text="Dec", font=("Consolas", 16),
                                       command=self.evt_btc_dec).place(x=360, y=150)
        self._btc_bit = tkinter.Button(self.main_frame, text="Bits", font=("Consolas", 16),
                                       command=self.evt_btc_bit).place(x=480, y=150)
        self._btc_hex = tkinter.Button(self.main_frame, text="Hex", font=("Consolas", 16),
                                       command=self.evt_btc_hex).place(x=420, y=150)
        self._rd_dec = tkinter.Button(self.main_frame, text="Random", font=("Consolas", 16),
                                      command=self.evt_rd_dec).place(x=15, y=150)
        ...
        self._jump1_dec = tkinter.Button(self.main_frame, text=" + ", font=("Consolas", 16), command=self.evt_jump1_dec,
                                         fg='green').place(x=230, y=150)
        self._jump_dec = tkinter.Button(self.main_frame, text=" - ", font=("Consolas", 16),
                                        command=self.evt_jump_rm1_dec, fg='red').place(x=110, y=150)
        self.labeladdr = tkinter.Label(self.main_frame,
                                       text=" When Searching for adress \n it will generate \n a random private key \n this will not match the address ",
                                       font=("Arial", 8), fg='red').place(x=700, y=135)
        self._bt_ip = tkinter.Button(self.main_frame, text="Address", font=("Consolas", 16),
                                     command=self.evt_btc_add).place(x=570, y=150)
        ...
        self.txt_outputbin = tkinter.Entry(self.main_frame, textvariable=self._stringvar_bin, width=56,
                                           font=("Consolas", 16))
        ...
        self.txt_outputbit = tkinter.Entry(self.main_frame, textvariable=self._stringvar_bit, width=5,
                                           font=("Consolas", 16))
        ...
        self.txt_outputdec = tkinter.Entry(self.main_frame, textvariable=self._stringvar_dec, width=50,
                                           font=("Consolas", 16))
        ...
        self.txt_outputhex = tkinter.Entry(self.main_frame, textvariable=self._stringvar_hex, width=48,
                                           font=("Consolas", 16))
        ...
        self.widgetsnake = tkinter.Button(self._window, text="BTC Snake Game ", font=("Arial", 10), bg="purple",
                                          command=MIZ.opensnake).place(x=30, y=650)
        self.widgetHunter = tkinter.Button(self._window, text="16x16 BTC Hunter ", font=("Arial", 10), bg="gold",
                                           command=MIZ.hunter16x16).place(x=750, y=650)
        self.lbl = tkinter.Label(self._window, font=('calibri', 28, 'bold'), background='#F0F0F0', foreground='purple')
        self.lbl.place(x=10, y=30)
        self.cpu_label = tkinter.Label(self._window, font=('calibri', 14, 'bold'), background='#F0F0F0',
                                       foreground='red')
        self.cpu_label.place(x=190, y=650)
        self.ram_label = tkinter.Label(self._window, font=('calibri', 14, 'bold'), background='#F0F0F0',
                                       foreground='red')
        ...
        self.tpk = tkinter.Label(self._window, text="Total Private Keys : ", font=("Arial", 12), bg="#F0F0F0",
                                 fg="Black").place(x=240, y=30)
        self.totalC = tkinter.Label(self._window, bg="#F0F0F0", font=("Arial", 12), text="")
        self.totalC.place(x=380, y=30)
        self.totaladd = tkinter.Label(self._window, text="Total Addresses   : ", font=("Arial", 12), bg="#F0F0F0",
                                      fg="Black").place(x=240, y=50)
        self.totalA = tkinter.Label(self._window, bg="#F0F0F0", font=("Arial", 12), text="")
        self.totalA.place(x=380, y=50)
        self.addcount = tkinter.Label(self._window, text=MIZ.countadd(), font=("Arial", 14), bg="#F0F0F0",
                                      fg="purple").place(x=80, y=80)
        self.pricelable_data = f"Todays Bitcoin Price £ {MIZ.price()} "
        self.pricelable = tkinter.Label(self._window, text=self.pricelable_data, font=("Arial", 14), bg="#F0F0F0",
                                        fg="purple").place(x=90, y=610)
        ########### about_frame ###########
        self.about1 = tkinter.Frame(master=self.about_frame, bg='#F0F0F0')
        self.about1.pack(fill='both', expand='yes')
        self.editArea = tkst.ScrolledText(master=self.about1, wrap=tkinter.WORD, width=40, height=16,
                                          font=("Arial", 12))
        self.editArea.pack(padx=10, pady=90, fill=tkinter.BOTH, expand=True)
        self.editArea.insert(tkinter.INSERT, MIZINFO.information)
        ########### brain_frame ###########
        self.totalbw = tkinter.Label(self.brain_frame, text="Total Found ", font=("Arial", 18), bg="#F0F0F0",
                                     fg="purple").place(x=690, y=70)
        self.foundbw = tkinter.Label(self.brain_frame, bg="#F0F0F0", font=("Arial", 23), text="0")
        self.foundbw.place(x=750, y=120)
        self.brain_update = tkinter.Label(self.brain_frame, bg="#F0F0F0", font=("Arial", 12), text="", width=80,
                                          fg="Red")
        ...
        self.start1 = tkinter.Button(self.brain_frame, text="Start", font=("Arial", 13), bg="#F0F0F0",
                                     command=self.start, fg='green').place(x=700, y=180)
        self.stop1 = tkinter.Button(self.brain_frame, text="Stop", font=("Arial", 13), bg="#F0F0F0", command=self.stop,
                                    fg='red').place(x=760, y=180)
        ...
        self._btc_bin = tkinter.Button(self.brain_frame, text="Enter", font=("Consolas", 16),
                                       command=self.Random_brain_single).place(x=545, y=75)
        self.titleb = tkinter.Label(self.brain_frame, text="Brain Wallet Words ", font=("Arial", 16), bg="#F0F0F0",
                                    fg="Black").place(x=380, y=260)
        self.titleerror = tkinter.Label(self.brain_frame,
                                        text="!!! Error to be Fixed !!! \n 1 Word from list \n Not stopping  Error !!! ",
                                        font=("Arial", 8), bg="#F0F0F0", fg="red").place(x=200, y=230)
        self.titlemax = tkinter.Label(self.brain_frame, text="!!! MAX 25 -26 !!!", font=("Arial", 12), bg="#F0F0F0",
                                      fg="red").place(x=25, y=230)
        self.title1 = tkinter.Label(self.brain_frame,
                                    text="Brain Wallet \n Random Generator \n Online & Offline \n Pick Ammount \n to Generate",
                                    font=("Arial", 8), bg="#F0F0F0", fg="Black").place(x=15, y=150)
        self.my_button = tkinter.Button(self.brain_frame, text="1 Word List (On-Line) ", font=("Arial", 10),
                                        bg="#ee6b6e", command=self.Random_brain_online1).place(x=200, y=150)
        self.my_button = tkinter.Button(self.brain_frame, text="Brain Words (On-Line) ", font=("Arial", 10),
                                        bg="#A3E4A7", command=self.Random_brain_online).place(x=350, y=150)
        self.my_button = tkinter.Button(self.brain_frame, text="Brain String (On-Line) ", font=("Arial", 10),
                                        bg="#F3E4C8", command=self.Random_brain_online2).place(x=510, y=150)
        self.my_button = tkinter.Button(self.brain_frame, text="1 Word List (Off-Line) ", font=("Arial", 10),
                                        bg="#ee6b6e", command=self.Random_brain_offline1).place(x=200, y=200)
        self.my_button = tkinter.Button(self.brain_frame, text="Brain Words (Off-Line) ", font=("Arial", 10),
                                        bg="#A3E4A7", command=self.Random_brain_offline).place(x=350, y=200)
        self.my_button = tkinter.Button(self.brain_frame, text="Brain String (Off-Line) ", font=("Arial", 10),
                                        bg="#F3E4C8", command=self.Random_brain_offline2).place(x=510, y=200)
        self.get_infoBRAIN = tkinter.Button(self.brain_frame, text="Information/Help", width=16,
                                            font=("arial", 10, "bold"), activebackground="#F0F0F0", fg="red",
                                            bg="#F0F0F0", command=self.informationBRAIN, relief=RAISED, bd=3).place(
            x=710, y=535)
        ########### crypto_frame ###########
        self.bwg = tkinter.Label(self.crypto_frame, text="Crypto Wallet Generator ", font=("Arial", 20), bg="#F0F0F0",
                                 fg="Black").place(x=180, y=100)
        ...
        self.r1 = tkinter.Button(self.crypto_frame, text=" Off-Line Random ", font=("Arial", 13), bg="#A3E4D7",
                                 command=self.Random_Bruteforce_Speed).place(x=15, y=220)
        self.bal1 = tkinter.Button(self.crypto_frame, text=" On-line Random  ", font=("Arial", 13), bg="#A3E4D7",
                                   command=self.Random_Bruteforce_Speed_online).place(x=15, y=260)
        self.s1 = tkinter.Button(self.crypto_frame, text=" Off-Line Sequential Start-Stop", font=("Arial", 13),
                                 bg="#B3B4D7", command=self.Sequential_Bruteforce_speed).place(x=170, y=220)
        self.bals1 = tkinter.Button(self.crypto_frame, text=" On-Line Sequential Start-Stop", font=("Arial", 13),
                                    bg="#B3B4D7", command=self.Sequential_Bruteforce_speed_online).place(x=170, y=260)
        self.sb1 = tkinter.Button(self.crypto_frame, text=" Off-Line Backward Stop-Start ", font=("Arial", 13),
                                  bg="#C3C4D7", command=self.Sequential_Bruteforce_speed_back).place(x=415, y=220)
        self.balsb1 = tkinter.Button(self.crypto_frame, text=" On-Line Backward Stop-Start ", font=("Arial", 13),
                                     bg="#C3C4D7", command=self.Sequential_Bruteforce_speed_back_online).place(x=415,
                                                                                                               y=260)
        self.start = tkinter.Button(self.crypto_frame, text="Start", font=("Arial", 13), bg="#F0F0F0",
                                    command=self.start, fg='green').place(x=700, y=180)
        self.stop = tkinter.Button(self.crypto_frame, text="Stop", font=("Arial", 13), bg="#F0F0F0", command=self.stop,
                                   fg='red').place(x=760, y=180)
        self.totalbtc = tkinter.Label(self.crypto_frame, text="Total Found ", font=("Arial", 18), bg="#F0F0F0",
                                      fg="purple").place(x=690, y=70)
        self.foundbtc = tkinter.Label(self.crypto_frame, bg="#F0F0F0", font=("Arial", 23), text="0")
        self.foundbtc.place(x=750, y=120)
        self.get_infoMAIN = tkinter.Button(self.crypto_frame, text="Information/Help", width=16,
                                           font=("arial", 10, "bold"), activebackground="#F0F0F0", fg="red",
                                           bg="#F0F0F0", command=self.informationMAIN, relief=RAISED, bd=3).place(x=710,
                                                                                                                  y=535)
        ########### page_frame ###########
        self.bwgpage = tkinter.Label(self.page_frame,
                                     text="Bitcoin&ETH Wallet Generator Based on Keys.lol 128 Private Keys per page",
                                     font=("Arial", 17), bg="#F0F0F0", fg="Black").place(x=20, y=100)
        ...
        self.r1page = tkinter.Button(self.page_frame, text=" Generate Random  ", font=("Arial", 13), bg="#A3E4D7",
                                     command=self.Random_Bruteforce_Speed_page).place(x=60, y=220)
        self.s1page = tkinter.Button(self.page_frame, text=" Sequential Start-Stop", font=("Arial", 13), bg="#B3B4D7",
                                     command=self.Sequential_Bruteforce_speed_page).place(x=240, y=220)
        self.sb1page = tkinter.Button(self.page_frame, text=" Backward Stop-Start ", font=("Arial", 13), bg="#C3C4D7",
                                      command=self.Sequential_Bruteforce_speed_back_page).place(x=430, y=220)
        self.startpage = tkinter.Button(self.page_frame, text="Start", font=("Arial", 13), bg="#F0F0F0", command=start1,
                                        fg='green').place(x=700, y=180)
        self.stoppage = tkinter.Button(self.page_frame, text="Stop", font=("Arial", 13), bg="#F0F0F0", command=stop1,
                                       fg='red').place(x=760, y=180)
        self.totalbtc_page = tkinter.Label(self.page_frame, text="Total Found ", font=("Arial", 18), bg="#F0F0F0",
                                           fg="purple").place(x=690, y=70)
        self.foundbtc_page = tkinter.Label(self.page_frame, bg="#F0F0F0", font=("Arial", 23), text="0")
        self.foundbtc_page.place(x=750, y=120)
        self.get_infoPAGE = tkinter.Button(self.page_frame, text="Information/Help", width=16,
                                           font=("arial", 10, "bold"), activebackground="#F0F0F0", fg="red",
                                           bg="#F0F0F0", command=self.informationPAGE, relief=RAISED, bd=3).place(x=710,
                                                                                                                  y=535)
        ########### word_frame ###########
        self.totalw = tkinter.Label(self.word_frame, text="Total Found ", font=("Arial", 18), bg="#F0F0F0",
                                    fg="purple").place(x=690, y=70)
        ...
        self._txt_inputword.insert(0,
                                   'bacon bacon bacon bacon bacon bacon bacon bacon bacon bacon bacon bacon bacon bacon bacon bacon bacon bacon bacon bacon bacon bacon bacon bacon')
        self._txt_inputword.place(x=90, y=80)
        self._txt_inputword.focus()
        self._word_bin = tkinter.Button(self.word_frame, text="Enter", font=("Consolas", 16),
                                        command=self.Random_word_single).place(x=545, y=75)
        self.titlem = tkinter.Label(self.word_frame, text="Mnemonic Words ", font=("Arial", 16), bg="#F0F0F0",
                                    fg="Black").place(x=380, y=250)
        self.titlem1 = tkinter.Label(self.word_frame,
                                     text="Random Mnemonic Wallet Generator Online Pick Ammount of Words to Generate",
                                     font=("Arial", 12), bg="#F0F0F0", fg="Black").place(x=60, y=130)
        self.titlem2 = tkinter.Label(self.word_frame,
                                     text="Random Mnemonic Wallet Generator Offline Pick Ammount of Words to Generate",
                                     font=("Arial", 12), bg="#F0F0F0", fg="Black").place(x=60, y=190)
        self.my_buttonword = tkinter.Button(self.word_frame, text="Random Single", font=("Arial", 11), bg="#A3B4A7",
                                            command=self.Random_word_random).place(x=700, y=220)
        self.my_buttonword = tkinter.Button(self.word_frame, text="1 Word ", font=("Arial", 10), bg="#A3E4A7",
                                            command=self.Random_word_online).place(x=20, y=160)
        self.my_buttonword = tkinter.Button(self.word_frame, text="3 Words ", font=("Arial", 10), bg="#A3E4B7",
                                            command=self.Random_word_online1).place(x=85, y=160)
        self.my_buttonword = tkinter.Button(self.word_frame, text="6 Words ", font=("Arial", 10), bg="#A3E4C7",
                                            command=self.Random_word_online2).place(x=155, y=160)
        self.my_buttonword = tkinter.Button(self.word_frame, text="9 Words ", font=("Arial", 10), bg="#A3E4D7",
                                            command=self.Random_word_online3).place(x=225, y=160)
        self.my_buttonword = tkinter.Button(self.word_frame, text="12 Words ", font=("Arial", 10), bg="#A3E4E7",
                                            command=self.Random_word_online4).place(x=295, y=160)
        self.my_buttonword = tkinter.Button(self.word_frame, text="15 Words ", font=("Arial", 10), bg="#A3E4F7",
                                            command=self.Random_word_online5).place(x=373, y=160)
        self.my_buttonword = tkinter.Button(self.word_frame, text="18 Words ", font=("Arial", 10), bg="#F3E4A8",
                                            command=self.Random_word_online6).place(x=450, y=160)
        self.my_buttonword = tkinter.Button(self.word_frame, text="21 Words ", font=("Arial", 10), bg="#F3E4B8",
                                            command=self.Random_word_online7).place(x=527, y=160)
        self.my_buttonword = tkinter.Button(self.word_frame, text="24 Words ", font=("Arial", 10), bg="#F3E4C8",
                                            command=self.Random_word_online8).place(x=603, y=160)
        self.my_buttonword = tkinter.Button(self.word_frame, text="1 Word ", font=("Arial", 10), bg="#A3E4A7",
                                            command=self.Random_word_offline).place(x=20, y=220)
        self.my_buttonword = tkinter.Button(self.word_frame, text="3 Words ", font=("Arial", 10), bg="#A3E4B7",
                                            command=self.Random_word_offline1).place(x=85, y=220)
        self.my_buttonword = tkinter.Button(self.word_frame, text="6 Words ", font=("Arial", 10), bg="#A3E4C7",
                                            command=self.Random_word_offline2).place(x=155, y=220)
        self.my_buttonword = tkinter.Button(self.word_frame, text="9 Words ", font=("Arial", 10), bg="#A3E4D7",
                                            command=self.Random_word_offline3).place(x=225, y=220)
        self.my_buttonword = tkinter.Button(self.word_frame, text="12 Words ", font=("Arial", 10), bg="#A3E4E7",
                                            command=self.Random_word_offline4).place(x=295, y=220)
        self.my_buttonword = tkinter.Button(self.word_frame, text="15 Words ", font=("Arial", 10), bg="#A3E4F7",
                                            command=self.Random_word_offline5).place(x=373, y=220)
        self.my_buttonword = tkinter.Button(self.word_frame, text="18 Words ", font=("Arial", 10), bg="#F3E4A8",
                                            command=self.Random_word_offline6).place(x=450, y=220)
        self.my_buttonword = tkinter.Button(self.word_frame, text="21 Words ", font=("Arial", 10), bg="#F3E4B8",
                                            command=self.Random_word_offline7).place(x=527, y=220)
        self.my_buttonword = tkinter.Button(self.word_frame, text="24 Words ", font=("Arial", 10), bg="#F3E4C8",
                                            command=self.Random_word_offline8).place(x=603, y=220)
        self.get_infoWORD = tkinter.Button(self.word_frame, text="Information/Help", width=16,
                                           font=("arial", 10, "bold"), activebackground="#F0F0F0", fg="red",
                                           bg="#F0F0F0", command=self.informationWORD, relief=RAISED, bd=3).place(x=710,
                                                                                                                  y=535)
        ########### hex_frame ###########
        self.hext = tkinter.Label(self.hex_frame,
                                  text="Rotation5Bit 20 Scans 128 private keys per scan 12,800 Addresses  ",
                                  font=("Arial", 14), bg="#F0F0F0", fg="Black").place(x=30, y=95)
        self.hexl1 = tkinter.Label(self.hex_frame, text="Private Keys 1 - 10  ", font=("Arial", 14), bg="#F0F0F0",
                                   fg="purple").place(x=150, y=350)
        self.hexl2 = tkinter.Label(self.hex_frame, text=" | ", font=("Arial", 18), bg="#F0F0F0", fg="purple").place(
            x=410, y=350)
        self.hexl3 = tkinter.Label(self.hex_frame, text="Private Keys 11 - 20  ", font=("Arial", 14), bg="#F0F0F0",
                                   fg="purple").place(x=550, y=350)
        ...
        self.labelstarthexnum0 = tkinter.Label(self.hex_frame, text="2", font=("Arial", 16), fg='red').place(x=120,
                                                                                                             y=130)
        ...
        self.labelstarthexnum1 = tkinter.Label(self.hex_frame, text="3", font=("Arial", 16), fg='red').place(x=175,
                                                                                                             y=130)
        ...
        self.labelstarthexnum2 = tkinter.Label(self.hex_frame, text="4", font=("Arial", 16), fg='red').place(x=230,
                                                                                                             y=130)
        ...
        self.labelstarthexnum3 = tkinter.Label(self.hex_frame, text="5", font=("Arial", 16), fg='red').place(x=285,
                                                                                                             y=130)
        ...
        self.labelstarthexnum4 = tkinter.Label(self.hex_frame, text="6", font=("Arial", 16), fg='red').place(x=340,
                                                                                                             y=130)
        ...
        self.labelstarthexnum5 = tkinter.Label(self.hex_frame, text="7", font=("Arial", 16), fg='red').place(x=395,
                                                                                                             y=130)
        ...
        self.labelstarthexnum6 = tkinter.Label(self.hex_frame, text="8", font=("Arial", 16), fg='red').place(x=450,
                                                                                                             y=130)
        ...
        self.labelstarthexnum7 = tkinter.Label(self.hex_frame, text="9", font=("Arial", 16), fg='red').place(x=505,
                                                                                                             y=130)
        ...
        self.labelstarthexnum8 = tkinter.Label(self.hex_frame, text="10", font=("Arial", 16), fg='red').place(x=560,
                                                                                                              y=130)
        ...
        self.labelstarthexnum9 = tkinter.Label(self.hex_frame, text="11", font=("Arial", 16), fg='red').place(x=60,
                                                                                                              y=235)
        ...
        self.labelstarthexnum10 = tkinter.Label(self.hex_frame, text="12", font=("Arial", 16), fg='red').place(x=120,
                                                                                                               y=235)
        ...
        self.labelstarthexnum11 = tkinter.Label(self.hex_frame, text="13", font=("Arial", 16), fg='red').place(x=175,
                                                                                                               y=235)
        ...
        self.labelstarthexnum12 = tkinter.Label(self.hex_frame, text="14", font=("Arial", 16), fg='red').place(x=230,
                                                                                                               y=235)
        ...
        self.labelstarthexnum13 = tkinter.Label(self.hex_frame, text="15", font=("Arial", 16), fg='red').place(x=285,
                                                                                                               y=235)
        ...
        self.labelstarthexnum14 = tkinter.Label(self.hex_frame, text="16", font=("Arial", 16), fg='red').place(x=340,
                                                                                                               y=235)
        ...
        self.labelstarthexnum15 = tkinter.Label(self.hex_frame, text="17", font=("Arial", 16), fg='red').place(x=395,
                                                                                                               y=235)
        ...
        self.labelstarthexnum16 = tkinter.Label(self.hex_frame, text="18", font=("Arial", 16), fg='red').place(x=450,
                                                                                                               y=235)
        ...
        self.labelstarthexnum17 = tkinter.Label(self.hex_frame, text="19", font=("Arial", 16), fg='red').place(x=505,
                                                                                                               y=235)
        ...
        self.labelstarthexnum18 = tkinter.Label(self.hex_frame, text="20", font=("Arial", 16), fg='red').place(x=560,
                                                                                                               y=235)
        ...
        self.hex1 = tkinter.Button(self.hex_frame, text=" Rotation 5 Start Scan ", font=("Arial", 15), bg="#A3E4D7",
                                   command=self.rotation_five).place(x=630, y=240)
        self.start3 = tkinter.Button(self.hex_frame, text="Start", font=("Arial", 13), bg="#F0F0F0", command=start3,
                                     fg='green').place(x=700, y=180)
        self.stop3 = tkinter.Button(self.hex_frame, text="Stop", font=("Arial", 13), bg="#F0F0F0", command=stop3,
                                    fg='red').place(x=760, y=180)
        self.totalbtc_rot = tkinter.Label(self.hex_frame, text="Total Found ", font=("Arial", 18), bg="#F0F0F0",
                                          fg="purple").place(x=690, y=70)
        self.foundbtc_rot = tkinter.Label(self.hex_frame, bg="#F0F0F0", font=("Arial", 23), text="0")
        self.foundbtc_rot.place(x=750, y=120)
        self.get_infoROT = tkinter.Button(self.hex_frame, text="Information/Help", width=16, font=("arial", 10, "bold"),
                                          activebackground="#F0F0F0", fg="red", bg="#F0F0F0",
                                          command=self.informationROT, relief=RAISED, bd=3).place(x=710, y=535)
        ########### mining_frame ###########
        self.mine_title = tkinter.Label(self.mine_frame, text="Bitcoin Solo Mining ", font=("Arial", 20), bg="#F0F0F0",
                                        fg="Black").place(x=180, y=100)
        self.labeladd_mine = tkinter.Label(self.mine_frame, text="Insert Your Address bitcoin Address  ",
                                           font=("Arial", 15), fg="red").place(x=220, y=140)
        self._txt_inputadd_mine = tkinter.Entry(self.mine_frame, width=40, font=("Consolas", 16))
        self._txt_inputadd_mine.insert(0, '35ggvBxYGiLEWUmU6d7cvzP6Xqw2oCDHFs')
        ...
        self.startmine = tkinter.Button(self.mine_frame, text="Start", font=("Arial", 13), bg="#F0F0F0",
                                        command=self.miz_miner, fg='green').place(x=700, y=180)
        ...
        self.totalbtc_mine = tkinter.Label(self.mine_frame, text="Total Found ", font=("Arial", 18), bg="#F0F0F0",
                                           fg="purple").place(x=690, y=70)
        self.foundbtc_mine = tkinter.Label(self.mine_frame, bg="#F0F0F0", font=("Arial", 23), text="0")
        self.foundbtc_mine.place(x=750, y=120)
        self.get_infoMINE = tkinter.Button(self.mine_frame, text="Information/Help", width=16,
                                           font=("arial", 10, "bold"), activebackground="#F0F0F0", fg="red",
                                           bg="#F0F0F0", command=self.informationMINE, relief=RAISED, bd=3).place(x=710,
                                                                                                                  y=535)
        ########### recovery_frame ###########
        self.recovery_title = tkinter.Label(self.recovery_frame, text=" WIF HEX DEC Recovery Tools ",
                                            font=("Arial", 20), bg="#F0F0F0", fg="Black").place(x=200, y=80)
        self.labeladd_WIF = tkinter.Label(self.recovery_frame,
                                          text="WIF HERE (WIF Recovery Tool ****  MAX 10 MISSING  ****)  ",
                                          font=("Arial", 14), fg="#FF6700").place(x=90, y=130)
        ...
        self.labeladd_HEX = tkinter.Label(self.recovery_frame,
                                          text="HEX HERE (HEX Recovery Tool ****  MAX 10 MISSING  ****)  ",
                                          font=("Arial", 14), fg="#FF6700").place(x=90, y=195)
        ...
        self.labeladd_DEC = tkinter.Label(self.recovery_frame,
                                          text="DEC HERE (DEC Recovery Tool ****  MAX 18 MISSING  ****)  ",
                                          font=("Arial", 14), fg="#FF6700").place(x=90, y=265)
        ...
        self.labeladd_WORD = tkinter.Label(self.recovery_frame,
                                           text="Mnemonic HERE (Mnm Recovery Tool ****  MAX 5 MISSING  ****)  ",
                                           font=("Arial", 14), fg="#FF6700").place(x=90, y=330)
        ...
        self.labelREC = tkinter.Label(self.recovery_frame, text="Remaining ", font=("Arial", 18), fg="purple").place(
            x=260, y=500)
        self.labelWIF4 = tkinter.Label(self.recovery_frame, bg="#F0F0F0", font=("Arial", 18), text="", fg="red")
        self.labelWIF4.place(x=400, y=500)
        self.sqWIF = tkinter.Button(self.recovery_frame, text="WIF SEQ", font=("Arial", 12), bg="#F3F4F8",
                                    command=self.start_recovery_wif_S, fg='black').place(x=677, y=165)
        self.sqHEX = tkinter.Button(self.recovery_frame, text="HEX SEQ", font=("Arial", 12), bg="#F3F4F8",
                                    command=self.start_recovery_HEX_S, fg='black').place(x=677, y=230)
        self.sqDEC = tkinter.Button(self.recovery_frame, text="DEC SEQ", font=("Arial", 12), bg="#F3F4F8",
                                    command=self.start_recovery_DEC_S, fg='black').place(x=677, y=300)
        self.sqMNEMO = tkinter.Button(self.recovery_frame, text="Word SEQ", font=("Arial", 12), bg="#F3F4F8",
                                      command=self.start_recovery_MNEMO_S, fg='black').place(x=677, y=370)
        self.ranWIF = tkinter.Button(self.recovery_frame, text="WIF Random", font=("Arial", 12), bg="#F3E4C8",
                                     command=self.start_recovery_wif_R, fg='black').place(x=767, y=165)
        self.ranHEX = tkinter.Button(self.recovery_frame, text="HEX Random", font=("Arial", 12), bg="#F3E4C8",
                                     command=self.start_recovery_HEX_R, fg='black').place(x=767, y=230)
        self.ranDEC = tkinter.Button(self.recovery_frame, text="DEC Random", font=("Arial", 12), bg="#F3E4C8",
                                     command=self.start_recovery_DEC_R, fg='black').place(x=767, y=300)
        self.ranMNEMO = tkinter.Button(self.recovery_frame, text="Word Random", font=("Arial", 12), bg="#F3E4C8",
                                       command=self.start_recovery_MNEMO_R, fg='black').place(x=767, y=370)
        self.totalbtc_recovery = tkinter.Label(self.recovery_frame, text="Total Found ", font=("Arial", 18),
                                               bg="#F0F0F0", fg="purple").place(x=690, y=70)
        ...
        self.get_infoREC = tkinter.Button(self.recovery_frame, text="Information/Help", width=16,
                                          font=("arial", 10, "bold"), activebackground="#F0F0F0", fg="red",
                                          bg="#F0F0F0", command=self.informationREC, relief=RAISED, bd=3).place(x=710,
                                                                                                                y=535)
        self.labeladd_ADD = tkinter.Label(self.recovery_frame, text="Address looking For", font=("Arial", 11),
                                          fg="#FF6700").place(x=20, y=515)
    ...
    def informationcal(self):
        ...
        tkinter.Label(self.windowcal_informationcal, fg="black", font=("arial", 11, "bold", "italic"),
                      text=MIZINFO.infocal, bg="#F0F0F0").place(x=5, y=15)
    ...
    def informationROT(self):
        ...
        self.widget['image'] = self.widget.miz_image_png
        self.widget.place(x=150, y=300)
        tkinter.Label(self.window_informationROT, fg="black", font=("arial", 11, "bold", "italic"),
                      text=MIZINFO.infoROT, bg="#F0F0F0").place(x=5, y=15)
    ...
    def informationREC(self):
        ...
        self.widget['image'] = self.widget.miz_image_png
        self.widget.place(x=150, y=300)
        tkinter.Label(self.window_informationREC, fg="black", font=("arial", 11, "bold", "italic"),
                      text=MIZINFO.infoREC, bg="#F0F0F0").place(x=5, y=15)
    ...
    def informationMAIN(self):
        ...
        self.widget['image'] = self.widget.miz_image_png
        self.widget.place(x=150, y=300)
        tkinter.Label(self.window_informationMAIN, fg="black", font=("arial", 11, "bold", "italic"),
                      text=MIZINFO.infoMAIN, bg="#F0F0F0").place(x=5, y=15)
    ...
    def informationPAGE(self):
        ...
        tkinter.Label(self.window_informationPAGE, fg="black", font=("arial", 11, "bold", "italic"),
                      text=MIZINFO.infoPAGE, bg="#F0F0F0").place(x=5, y=15)
    ...
    def informationBRAIN(self):
        ...
        tkinter.Label(self.window_informationBRAIN, fg="black", font=("arial", 11, "bold", "italic"),
                      text=MIZINFO.infoBRAIN, bg="#F0F0F0").place(x=5, y=15)
    ...
    def informationWORD(self):
        ...
        tkinter.Label(self.window_informationWORD, fg="black", font=("arial", 11, "bold", "italic"),
                      text=MIZINFO.infoWORD, bg="#F0F0F0").place(x=5, y=15)
    ...
    def informationMINE(self):
        ...
        tkinter.Label(self.window_informationMINE, fg="black", font=("arial", 11, "bold", "italic"),
                      text=MIZINFO.infoMINE, bg="#F0F0F0").place(x=5, y=15)
    ...
    def evaluation_opr(self):
        ...
        if self.work_done == "+":
            try:
                ...
                self.text_valuecal.set(int(result_take)) if int(result_take) == result_take else self.text_valuecal.set(
                    result_take)
            except:
            ...
            try:
                ...
                tkinter.messagebox.showerror("Input Error",
                                             "Please write number in the right position.Please read the informationcal carefully")
                self.informationcal()
                self.reset_now()
            ...
            try:
                ...
                self.text_valuecal.set(int(self.fact)) if int(self.fact) == self.fact else self.text_valuecal.set(
                    self.fact)
            ...
            try:
                if eval(self.n1) > eval(self.n2):
                    ...
                    self.text_valuecal.set(int(result_take)) if int(
                        result_take) == result_take else self.text_valuecal.set(result_take)
                else:
    ...
    def rotation_results(self, dec, dec0, dec1, dec2, dec3, dec4, dec5, dec6, dec7, dec8, dec9, dec10, dec11, dec12,
                         dec13, dec14, dec15, dec16, dec17, dec18):
        global total, totaladd
        scantext = MIZ.hexhunter(self, dec, dec0, dec1, dec2, dec3, dec4, dec5, dec6, dec7, dec8, dec9, dec10, dec11,
    ...
    def rotation_five(self):
        ...
        while run3:
            ...
            self.rotation_results(dec, dec0, dec1, dec2, dec3, dec4, dec5, dec6, dec7, dec8, dec9, dec10, dec11, dec12,
                                  dec13, dec14, dec15, dec16, dec17, dec18)
    ...
    def popwinner(self):
        ...
        self.editAreapop = tkst.ScrolledText(master=self.popwin, wrap=tkinter.WORD, width=70, height=6,
                                             font=("Arial", 12))
    ...
    def startpop(self):
        ...
        self.label = tkinter.Label(self.pop,
                                   text='Welcome to BitcoinHunter...... \n\n Made By Mizogg.co.uk \n\n Version 1.13 07/12/22').pack(
            pady=10)
        self.label1 = tkinter.Label(self.pop,
                                    text="BitcoinHunter application use at your own risk.\n There is no promise of warranty.\n\n  Auto Agree 5 secs",
                                    font=('Helvetica 8 bold')).pack(pady=10)
